...
public class PacketGetFriendListInfoScRsp extends BasePacket {
    ...
    public PacketGetFriendListInfoScRsp(FriendList friendList) {
        ...
        var consoleFriend = SimpleInfo.newInstance()
                ...
                .setPlatformType(PlatformType.EDITOR)
                .addSimpleAvatarInfo(SimpleAvatarInfo.newInstance().setAvatarId(serverFriendInfo.getDisplayAvatarId()).setLevel(serverFriendInfo.getDisplayAvatarLevel()))
